...
const Search = () => {
  ...
  useEffect(() => {
    const sampleDistricts = [
      'Приморский', 'Выборгский', 'Калининский', 'Центральный',
      'Василеостровский', 'Московский', 'Невский', 'Фрунзенский',
      'Красногвардейский', 'Кировский', 'Петроградский',
      'Медвежий угол', 'Веселая собака', 'Тестовый'
    ];
